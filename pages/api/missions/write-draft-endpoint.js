...
export default async function missingsBriefingHandler(req, res) {
  ...
  if (req.method === "POST") {
    ...
    const chat_completion = await openai.createChatCompletion({
      ...
      messages: [
        {
          role: "system",
          content: `You are an expert at generating an interesting research report for given prompt in the areas of ${expertiseString}. You always return answers with no explanation. You always return responses in html format inside a <div></div>.`,
        },
        {
          role: "user",
