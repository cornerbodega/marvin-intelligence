...
// export async function generateExpertiseFunction({ expertiseInput }) {
...
// export async function generateAgentNameFunction({ expertiseOutput }) {
...
// export async function addAgentFunction({ expertiseOutput, agentName, userId }) {
//   console.log("ADD AGENT FUNCTION");

//   const agentId = 689; /* Logic to add agent using expertiseOutput, agentName, and userId */

//   return { agentId };
// }

// export async function generateExpertiseFunction() {
//   console.log("GENERATE EXPERTISE FUNCTION");
//   // returns expertise, needed for subsequent tasks
// }
// export async function generateAgentNameFunction() {
//   console.log("Generate AGENT Name Function");
// }
...
//   // returns agent id
// }
// export async function asscreateAgentFunction({
//   expertiseInput,
//   userId,
//   existingAgentNames,
//   specializedTraining,
...
export default async function handler(req, res) {
  console.log("ADD AGENT ENDPOINT");
  console.log("Input:");
  console.log(req.body);
  const { expertiseOutput, agentName, userId, agentId } = req.body;
  // console.log("expertiseOutput");
  // console.log(expertiseOutput);
  // export async function addAgentFunction({
  //   expertiseOutput,
  ...
  // const savedAddAgentAsyncTask = await saveAsyncTask({
  //   userId,
  //   taskType: "addAgent",
  ...
  //   }),
  // }).catch((error) => console.log(error));
  // console.log("savedAddAgentAsyncTask add-agent-endpoint");
